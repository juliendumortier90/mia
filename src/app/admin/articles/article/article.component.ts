...
export class AdminArticleComponent implements OnInit {
  ...
  private callUpdateArticle(article) {
    this.http.post('https://zq3s7ojolk.execute-api.eu-west-1.amazonaws.com/prod/shop/add-item', article)
        .subscribe((data: any) => {
  ...
  private callDeleteArticle(article) {
    this.http.post('https://zq3s7ojolk.execute-api.eu-west-1.amazonaws.com/prod/shop/delete-item', { id: article.id})
        .subscribe((data: any) => {
